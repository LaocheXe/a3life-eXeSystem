        ...
        <div class="tab-pane fade" id="houses">
            ...
            <?php while($row_houses = mysql_fetch_object($houses_SQL)){ ?>
                <tr>
                    ...
                    <td><?php echo "<a href='house.php?id=".$row_houses->house_id."'>".$row_houses->house_id."</a>";?></td>
                    ...
                    <td><a href="house.php?id=<?php echo $row_houses->id;?>" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span></a></td>
                </tr>
            <?php 
            //END WHILE
                } ?>
...
//END IF HOUSING MARIO 2000
    ...
    //START REAL ALTIS LIFE HOUSING
        ...
        <div class="tab-pane fade" id="houses">
            ...
            <?php while($row_houses = mysql_fetch_object($houses_SQL)){ ?>
                <tr>
                    <td><?php echo "<a href='house.php?id=".$row_houses->id."'>".$row_houses->id."</a>";?></td>
